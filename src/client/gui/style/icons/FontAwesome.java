...
/**
 * Static Singleton Class for creating an icon Font based on FontAwesome icon fonts.
 */
public class FontAwesome {


    /**
     * private Font Holders
     */
    private Font brands;
    ...
    /**
     * Instance parameter for Singleton Design Pattern.
     */
    private static FontAwesome INSTANCE;

    /**
     * Constructor Class (Private): reads font files once,
    ...
    /**
     * returns INSTANCE or Creates it. Self-Explanatory Singleton Design Method
    ...
    /**
     * Returns FontAwesome Instance.fonts
     * @param type defines the icon type
     * @return Icon Font
     */
    public static Font getFont(int type) {
        FontAwesome faInstance = FontAwesome.getInstance();

        switch (type) {
            case BRANDS:
                return faInstance.brands;
            case SOLID:
                return faInstance.solid;
            case REGULAR:
                return faInstance.regular;
        }
        return null;
    }
    //Constants
